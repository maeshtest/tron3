...
import { Search, TrendingUp, ArrowRight, Flame, Activity, Shield, Zap, Globe, Users, BarChart3, ChevronRight, Smartphone, Download } from "lucide-react";
          ...
          >
            {loading
              ...
              : heroCoins.map((coin, idx) => (
                  ...
                  >
                    {idx === 0 && (
                      <span className="absolute -top-2 -right-2 bg-primary text-primary-foreground text-[10px] font-bold px-2 py-0.5 rounded-full">#1</span>
                    )}
          ...
          <div className="bg-gradient-to-r from-primary/10 to-accent/10 border border-border rounded-2xl p-8 md:p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input
                ...
                className="flex-1 h-10 rounded-lg bg-card border border-border px-4 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary"
              />
